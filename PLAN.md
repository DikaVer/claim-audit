...
Hidden reasoning is not available from OpenAI reasoning models. Confirmed in the smoke run: o3's reasoning content arrives encrypted. Claims are extracted from the agent's visible messages, tool calls and final report. Say this plainly in the write-up.
